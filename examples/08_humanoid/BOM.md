...
**Estimated total: $895.66**  ·  tier: prosumer
...
| Power | LiPo 4S 5000mAh | 1 | 40 | 40 | 74 Wh; est. load 57 W |
...
| Structure | 3D-printed frame (PLA/PETG) | 1 | 351.26 | 351.26 | ~15.97 kg material @ $22/kg |
| Structure | Fastener + bearing kit | 1 | 18 | 18 | M3 screws, heat inserts, 608 bearings |
| Wiring & misc | Wiring, connectors, JST/Dupont, sleeving | 1 | 56.4 | 56.4 | ~12% of electronics |
...
| left_joint_1 | 1.003 | DS3218 20kg servo | 2.0x |
| left_joint_2 | 0.973 | DS3218 20kg servo | 2.0x |
| left_joint_3 | 0.562 | DS3218 20kg servo | 3.5x |
| left_joint_4 | 0.531 | DS3218 20kg servo | 3.7x |
| left_joint_5 | 0.12 | DS3218 20kg servo | 16.3x |
| left_joint_6 | 0.09 | DS3218 20kg servo | 21.9x |
| left_joint_7 | 0.059 | DS3218 20kg servo | 33.2x |
| left_left_finger_joint | 0.196 | NEMA17 + lead screw | 305.9x |
| left_right_finger_joint | 0.196 | NEMA17 + lead screw | 305.9x |
| right_joint_1 | 1.003 | DS3218 20kg servo | 2.0x |
| right_joint_2 | 0.973 | DS3218 20kg servo | 2.0x |
| right_joint_3 | 0.562 | DS3218 20kg servo | 3.5x |
| right_joint_4 | 0.531 | DS3218 20kg servo | 3.7x |
| right_joint_5 | 0.12 | DS3218 20kg servo | 16.3x |
| right_joint_6 | 0.09 | DS3218 20kg servo | 21.9x |
| right_joint_7 | 0.059 | DS3218 20kg servo | 33.2x |
