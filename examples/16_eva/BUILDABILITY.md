# Physical build evidence — 16_eva
...
Declared model mass: 28.255 kg. 8 links have inferred mass. 5 joints require actuator integration.
...
No levitation system is designed. The free-base EVA model falls under gravity.
